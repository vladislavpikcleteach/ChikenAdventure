...
class StoryNode: Identifiable {
    let id = UUID()
    let text: String
    var choices: [StoryChoice] = []
    let endingType: StoryModel.EndingType?
    
    init(text: String, endingType: StoryModel.EndingType? = nil) {
        self.text = text
...
struct StoryChoice: Identifiable {
    ...
    let switchEndingTo: StoryModel.EndingType?
    
    init(text: String, nextNode: StoryNode?, switchEndingTo: StoryModel.EndingType? = nil) {
        self.text = text
